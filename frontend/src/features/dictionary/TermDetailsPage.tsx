    ...
    <div className="max-w-[1440px] mx-auto px-6 py-16">
      <div className="flex items-center justify-between mb-8">
        <button
          ...
          className="text-white bg-[#0f1419] pr-4  hover:bg-[#0f1419]/90 focus:ring-4 focus:outline-none focus:ring-[#0f1419]/50 box-border border border-transparent font-medium leading-5 rounded-full text-sm px-4 py-2.5 text-center inline-flex items-center dark:hover:bg-[#24292F] dark:focus:ring-[#24292F]/55"
        >
